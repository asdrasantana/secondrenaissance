---
title: Art of Ritual Residency
layout: plain
---
<div class="page-glow"></div>

<header class="relative min-h-[85vh] flex items-center justify-center text-center px-4 text-white overflow-hidden">
  <div class="absolute inset-0 z-0">
    <img src="/assets/img/art/residency-hero.jpg" alt="Art of Ritual Residency" class="w-full h-full object-cover">
