...
A [foundational paper](/papers) outlines the idea of a cultural paradigm shift or ‘[Second Renaissance](https://secondrenaissance.net/).’[^1]  Forthcoming essays will build on this inquiry, exploring its implications for specific areas of society -- such as climate, decision-making, education, and more.
...
[^1]:  [Barbier et al. (2024)](https://secondrenaissance.net/papers)
[^2]:  Machine metaphors for life appeared before the modern age (see e.g. Riskin (2013)) however their dominance was entrenched by the industrial revolution, proliferating with each new wave of empowering tech (e.g. mind as computer.) See e.g. Mumford (1967).
[^3]:  [Barbier et al. (2024)](https://secondrenaissance.net/papers) offers a more general summary of views and values core to the modern cultural paradigm. See also [Walker (2021)](https://www.ebsco.com/research-starters/social-sciences-and-humanities/characteristics-modernity).
[^4]:  See e.g. [Kleingeld (1999)](https://philpapers.org/archive/KLEKHA.pdf) on Kant
[^5]:  For expansion see Merchant (1980)
[^6]:  Kahneman (1979) is one early work that undermines the idea of Homo Economicus, the rational, self-interested decision-maker.
